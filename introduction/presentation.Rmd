...
2. Be able to perform simple data manipulation
...
- How to estimate simple statistical models
...
- The **base** approach to R (the old way)
- General programming in R
- Package development
- Efficient sharing work with your team
- Interactive dashboards (shiny apps)
- How to train advanced machine learning models
- Mathematics behind the statistical models

## R

- programovaci jazyk
- zamereni na statistiku
- open source
- velka cast napsana v C++ / fortran

## RStudio

- vyvojove prostredi
- primarne zamerene na praci s R
- pomocne nastroje pro tidyverse
- data viewer, plot viewer
- Python, Julia, C++, ...

## Tidyverse

- soubor knihoven v R
- prace s daty (dplyr, tidyr)
- vizualizace (ggplot2)
- statisticke modelovani (modelr)

## Vyhody R

- open source
- reprodukovatelnost vysledku
- snadne verzovani
- prostredi pro praci s daty (spolu s RStudiem)
- komunita
...
- R-bloggers
- Medium posts
- #TidyTuesdays on twitter

![](https://pbs.twimg.com/media/FgEanVfVUAA0JrF?format=jpg&name=4096x4096)
...
>>>>>>> c0128303b20dc911636c7497e23470c1bfb0db54
## Starwars summary
